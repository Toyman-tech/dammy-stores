...
function ThankYouContent() {
  ...
  useEffect(() => {
    ...
    // ✅ Fire Facebook Pixel Purchase event (Browser-side)
    if (typeof window !== "undefined" && typeof (window as any).fbq !== "undefined") {
        console.log("🔥 Firing Browser Pixel Purchase event", details)
    ...
    // 🚀 NEW: Fire Conversions API Purchase event (Server-side)
      ...
      try {
        const response = await fetch('/api/fb-capi', {
          ...
          body: JSON.stringify({
            ...
            content_name: details.package,
            order_id: details.orderNumber,
            external_id: details.orderNumber,
            email: details.email, // ✅ Now using actual customer email
            phone: details.phone, // ✅ Now using actual customer phone
          }),
        })
