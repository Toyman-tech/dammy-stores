  ...
  return (
    <section className="py-16 px-4 bg-[#0000003B]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 max-w-3xl mx-auto mt-10">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        <div className="grid grid-cols-1 max-w-[500px] mx-auto m-5">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        >
          ...
          We stand by our HIGH-QUALITY products, and your satisfaction is 100% guaranteed.<br />
          Here it is with proof also;
        </motion.p>
        <div className="grid grid-cols-1 max-w-[500px] mx-auto m-5">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
